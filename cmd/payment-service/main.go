...
import (
	...
	"github.com/herman-xphp/go-microservices-ecommerce/services/payment/handler"
...
func main() {
	...
	dbConfig := database.Config{
		...
		DBName:   getEnv("DB_NAME", "goshop_payment"),
	...
	// Start HTTP server
	log.Info().Str("port", httpPort).Msg("Payment Service HTTP starting")
